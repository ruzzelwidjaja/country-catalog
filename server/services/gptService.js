...
//   const prompt = `give me travel recommendations for ${countryName} in 4/5 small paragraphs separated with <br/><br/>`;
  ...
  const prompt = `For ${countryName}, provide 2 very brief key travel highlights. For each, give a title followed by '::' and then a brief description. Ensure each highlight is separated by a double newline.`;
  const params = {
    model: "gpt-4",
    // model: "gpt-3.5-turbo",
